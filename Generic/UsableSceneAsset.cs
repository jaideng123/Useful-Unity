...
/// </summary>
[System.Serializable]
public class UsableSceneAsset : ISerializationCallbackReceiver
{
#if UNITY_EDITOR
    ...
    public static implicit operator string(UsableSceneAsset sceneReference)
    {
...
/// </summary>
[CustomPropertyDrawer(typeof(UsableSceneAsset))]
